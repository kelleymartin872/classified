        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.ads.save')}} " method="post" enctype="multipart/form-data">
                            @csrf
                            <label for="file"><b class="mt-2"> Upload 3 Images</b></label>
                            ...
                            <label for="Category"><b class="mt-2"> Choose Category</b></label>
                            <div class="form-inline form-group mt-1">
                                <category-dropdown/>
